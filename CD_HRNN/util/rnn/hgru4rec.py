# -*- coding: utf-8 -*-
"""
Created on Tue Aug 30 17:10:11 2022
...
class HGRU4Rec:
 ...
 #       self.bpreg = bpreg ######
    ...
    def set_item_embeddings(self, E, values):
        ...
        #filtered_keys = [key for key in keys if key in self.itemidmap.index]
        #idx = self.itemidmap.loc[filtered_keys].dropna().values.astype(np.int)
