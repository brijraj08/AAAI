...
ratings= pd.read_csv("amazon_data_12_jan_2.csv")

#def make_sessions(data, session_th=30, is_ordered=False, user_key='user_id', item_key='item_id', time_key='ts'):
#def make_sessions(data, session_th=600, is_ordered=False, user_key='user_id', item_key='item_id', time_key='ts'):
#def make_sessions(data, session_th=365*86400, is_ordered=False, user_key='user_id', item_key='item_id', time_key='ts'):
...
"""
# 2. Split the dataset by new regime! go to util folder check split_newregim, rename it by split.
"""
