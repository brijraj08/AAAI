...
DATA_FOLDER=""
FILENAME_PATTERN ='ml_homosess.csv'
...
workflow.fit_transform(dataset).to_parquet(os.path.join(DATA_FOLDER, "mlhomocheck_processed_nvt"))

workflow.output_schema

workflow.save(os.path.join(DATA_FOLDER, "mlhomocheck_workflow_etl"))

sessions_gdf = cudf.read_parquet(os.path.join(DATA_FOLDER, "mlhomocheck_processed_nvt/part_0.parquet"))
...
save_time_based_splits(data=nvt.Dataset(sessions_gdf),
                       output_dir=os.path.join(DATA_FOLDER, "mlhomocheck_preproc_sessions_by_month"),
