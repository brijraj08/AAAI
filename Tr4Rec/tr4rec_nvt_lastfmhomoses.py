...
DATA_FOLDER=""
FILENAME_PATTERN ='lastfm_homosess_final.csv'
...
workflow.fit_transform(dataset).to_parquet(os.path.join(DATA_FOLDER, "lastfmhomoses_processed_nvt"))

workflow.output_schema

workflow.save(os.path.join(DATA_FOLDER, "lastfmhomoses_workflow_etl"))

sessions_gdf = cudf.read_parquet(os.path.join(DATA_FOLDER, "lastfmhomoses_processed_nvt/part_0.parquet"))
...
save_time_based_splits(data=nvt.Dataset(sessions_gdf),
                       output_dir=os.path.join(DATA_FOLDER, "lastfmhomoses_preproc_sessions_by_month"),
