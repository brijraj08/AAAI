# -*- coding: utf-8 -*-
"""
Created on Tue May 23 16:29:09 2023
...
#rsc15_train = '/stamp_data/stamp_train_full.txt' #root_path + project_name +'/datas/data/mlclu_train_full.txt'
#rsc15_test = '/stamp_data/stamp_test.txt'  #root_path + project_name +'/datas/data/mlclu_test.txt'
rsc15_train = '/stamp_data/cd/stamp_train_full.txt' #root_path + project_name +'/datas/data/mlclu_train_full.txt'
rsc15_test = '/stamp_data/cd/stamp_test.txt'  #root_path + project_name +'/datas/data/mlclu_test.txt'

mid_rsc15_emb_dict = "mlclu_emb_dict_a.data"
...
def load_tt_datas(config={}, reload=True):
    ...
    nload: 是否重新解析原始数据
    '''
    path = '/home/pankaj/brijraj1/stamp_data/'#'datas/mid_data'
    if reload:
