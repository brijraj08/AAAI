...
#rsc15_train = root_path + project_name +'/datas/data/mlhomoses829_train_full.txt'
#rsc15_test = root_path + project_name +'/datas/data/mlhomoses829_test.txt'
#mid_rsc15_emb_dict = "mlhomoses829_emb_dict.data"
rsc15_train = root_path + project_name +'/datas/data/mlts100ses829_train_full.txt'
rsc15_test = root_path + project_name +'/datas/data/mlts100ses829_test.txt'
mid_rsc15_emb_dict = "mltsses829_emb_dict.data"
