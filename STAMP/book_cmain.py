...
#rsc15_train = root_path + project_name +'/datas/data/book30daysts365_train_full.txt'
#rsc15_test = root_path + project_name +'/datas/data/book30daysts365_test.txt'
#mid_rsc15_emb_dict = "booktsses829_1_emb_dict.data"
rsc15_train = root_path + project_name +'/datas/data/bookhomo365_train_full.txt'
rsc15_test = root_path + project_name +'/datas/data/bookhomo365_test.txt'
mid_rsc15_emb_dict = "bookhomo365_emb_dict.data"
