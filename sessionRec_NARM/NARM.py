...
def train_gru(
    ...
    n_items=,# Vocabulary size:3405 for ml_CDses,3381 for ml_tsses,43302 for book_CDses,40295 for book_tsses,22861 for lastfm_CDses,22551 for lastfm_tsses,51622 for amazon_CDses, 39561 for amazon_tsses
